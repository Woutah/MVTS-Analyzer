...
class Ui_ApplyPythonWindow(object):
    def setupUi(self, ApplyPythonWindow):
        ...
        ApplyPythonWindow.resize(726, 235)
        icon = QIcon()
        icon.addFile(u":/Icons/icons/Custom Icons/execute_python.svg", QSize(), QIcon.Normal, QIcon.Off)
        ApplyPythonWindow.setWindowIcon(icon)
        self.actionSaveAs = QAction(ApplyPythonWindow)
        self.actionSaveAs.setObjectName(u"actionSaveAs")
        icon1 = QIcon()
        icon1.addFile(u":/Icons/icons/Tango Icons/actions/document-save-as.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/Icons/icons/Tango Icons/actions/document-open.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.actionOpenFromFile.setIcon(icon2)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/Icons/icons/Custom Icons/execute-python.svg", QSize(), QIcon.Normal, QIcon.Off)
    ...
    def retranslateUi(self, ApplyPythonWindow):
        ...
        self.label.setText(QCoreApplication.translate("ApplyPythonWindow", u"Note: the main dataframe is accesible in this window via \"model\" using either model.df (and optionally model.selection)", None))
