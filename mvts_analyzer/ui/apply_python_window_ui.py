...
class Ui_ApplyPythonWindow(object):
    def setupUi(self, ApplyPythonWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/Icons/icons/Other Icons/python-logo-only.svg", QSize(), QIcon.Normal, QIcon.Off)
    ...
    def retranslateUi(self, ApplyPythonWindow):
        ...
        self.label.setText(QCoreApplication.translate("ApplyPythonWindow", u"Note: the main dataframe is accesible in this window using self.df (and optionally self.df_selection)", None))
